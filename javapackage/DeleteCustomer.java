...
public class DeleteCustomer extends JInternalFrame implements ActionListener {
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == btnDel) {
			if (txtNo.getText().equals("")) {
				JOptionPane.showMessageDialog (this, "Please! Provide Account No. of Customer.",
		...
		try {
			//Show a Confirmation Dialog.
		    	int reply = JOptionPane.showConfirmDialog (this,
					"Are you Sure you want to Delete\n" + txtName.getText () + " Account details From BankSystem?",
	...
	void deleteFile () {
		...
		try {
			...
			if (records != null) {
				...
				JOptionPane.showMessageDialog (this, "Account details have been Deleted Successfuly.",
			...
			JOptionPane.showMessageDialog (this, "There are Some Problems with File",
